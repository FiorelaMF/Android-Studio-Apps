                                ...
                                new Response.Listener<String>() {
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        if (response.contains("SOLICITUD") && response.contains("OK")) {
                                            ...
                                            Toast.makeText(OlvidoActivity.this, "Se ha enviado el correo."
                                                    , Toast.LENGTH_SHORT).show();
                                            finish();
                                        } else if (response.contains("SOLICITUD") && response.contains("NO")) {
                                            progressBar.setVisibility(View.GONE);
                                            Toast.makeText(OlvidoActivity.this, "Algo falló. No se ha enviado el correo."
                                                    , Toast.LENGTH_SHORT).show();
                                            finish();
                                        } else if (response.contains("ER")) {
                                            progressBar.setVisibility(View.GONE);
                                            Toast.makeText(OlvidoActivity.this, "Algó falló. Revise sus datos."
                                                    , Toast.LENGTH_SHORT).show();
